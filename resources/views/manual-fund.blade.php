    ...
    <div class="default-theme">
        ...
        <body>
            ...
            <div wire:id="k3avItmW0YN9EgcVBf0J"
                ...
                <label class="mt-3 mb-3 text-gray-600 text-center font-bold gap-3 text-sm">Pay NGN{{ number_format($amount, 2) }}</label>
            ...
            <div 
            class="text-blue-500 text-center p-5  mt-5 text-sm justify-center items-stretch bg-blue-500 bg-opacity-20 self-stretch mt-4 px-6 py-3 rounded-xl">
            <strong text-black class="mb-5 mt-5">Bank Name</strong><br>
            <p class="mb-5 text-small">{{$account_details->bank_name}}</p>


            <strong text-black class="mb-5">Account Name</strong><br>
            <p class="mb-5 text-small">{{$account_details->account_name}}</p>


            <hr>
            <strong text-black class="mt-4">Account Number</strong><br>
            <p text-small>{{$account_details->bank_account}}</p>
                ...
                <form id="myDiv" action="fund-manual-now" enctype="multipart/form-data" text-center class="grid grid-cols-1" gap-3 method="POST">
                    @csrf

                    <label class="mt-5 mb-3 text-gray-600 text-center font-bold gap-3 text-sm">Upload Payment prove</label>
