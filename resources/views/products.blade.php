                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="uses" data-toggle="collapse" aria-expanded="false"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="products" data-toggle="collapse" aria-expanded="false"
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="caterogies" data-toggle="collapse" aria-expanded="false"
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    Copyright © 2023 Concept. All rights reserved. Dashboard by <a
