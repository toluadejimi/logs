    ...
    <div class="main-wrapper black">
        ...
        <header class="d-flex flex-wrap align-items-center justify-content-center dark py-3 mb-4 border-bottom">
            ...
            <ul class="nav col-12 col-md-auto mb-2 ml-3 justify-content-center  mb-md-0">
                <li><a href="/" class="nav-link badge badge-dark px-2 p-2 mr-2 link-secondary"><ion-icon name="home-outline"></ion-icon> Home</a></li>
                @if($user != null)
                <li><a href="/fund-wallet" class=" nav-link badge badge-dark p-2 mr-2 px-2 link-dark"><ion-icon name="wallet-outline"></ion-icon> Fund Wallet</a></li>
                @endif
                <li><a href="#" class="badge badge-dark p-2 mr-2 nav-link px-2 mb-2 link-dark"><ion-icon name="help-circle-outline"></ion-icon> FAQs</a></li>
                @if($user != null)
                <li><a href="/fund-account" class="badge  justify-content-center badge-danger p-2  center-block"><ion-icon name="wallet-outline"></ion-icon>
                    NGN{{ number_format(Auth::user()->wallet, 2) }}</a></li>
                @endif
            </ul>
            ...
            <ul class="nav col-md-auto mb-2  justify-content-center">
                ...
                <li><button type="button" data-toggle="modal" data-target="#register" class="btn btn-dark"><ion-icon name="person-add-outline"></ion-icon> Sign-up</button>
                </li>
            </ul>
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                <li> <a href="/profile" class="btn btn-secondary mr-2"> <ion-icon name="person-circle-outline"></ion-icon> My Account</a>
                </li>
                <li>  <a href="/log-out" class="btn btn-dark"><ion-icon name="log-out-outline"></ion-icon> Log Out</a></li>
            </ul>
        ...
        <section class="soc-category" id="content">
            ...
            <div class="container">
                   ...
                   {{-- Facebook --}}
                    ...
                    <form action="/allcatproduct" method="GET">
                        ...
                        <button type="submit" data-cat="48" data-collapse="#subcat_48" data-name="Hide accounts"
                            class="btn  btn-warning my-3 btn-sm btn-block">View all <ion-icon name="arrow-forward-outline"></ion-icon></button>
                    </form>
                ...
                <div class="card p-3">
                    ...
                    <p class="small">Regarding Social Media (SOMIA), it is evident that this is an effective and one of
                        the
                        most
                        potent means capable of pitching in almost every business industry and market. Presently all the
                        marketers make use Social Media  a platform for steering customers. There are some difficulties you
                        can meet when choosing the right Social Media sites for marketing purposes. It wont be confusing
                        if you initially define the Social Media requirements that are to be used and choose the right
                        supplier of Social Media accounts. The important thing is that nowadays people are highly
                        engaged with all types of SOMIA, and before to buy Social Media accounts first, you need to know
                        which one is best for you. And after that, some consideration should be given to the following
                        moments:</p>
                    <ul>
                    ...
                    <p class="small">On our website, you will get to know a lot of useful information about the contemporary Social
                        Media sites profitable for Marketing on Social Media.</p>
                    <p class="small">It is essential to take into consideration all the above factors before buying accounts of modern
                        Social Media.</p>
                    ...
                    <p class="small">It is essential to determine where the target audiences are spending their time. This could be
                    ...
                    <p class="small">The inactive accounts of Social Media are useless, even if they are accessible and well promoted.
                    ...
                    <p class="small">Try to determine what the users are searching for on SOMIA. This will bring you closer to profit.
                    </p>
                    ...
                    <p class="small">If you are looking for a reputed company to buy accounts, ACCSmarket.com is the right choice. On
                        our website, you can find best, reliable, and persistent Social Media accounts at an affordable
                        price.</p>
                    <p class="small">Choose and buy accounts Instagram, Facebook, Twitter, Reddit, Gmail, Yahoo, and many others for
