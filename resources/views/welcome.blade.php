...
<header class="d-flex flex-wrap align-items-center justify-content-center dark py-3 mb-4 border-bottom">
    ...
    <a href="/" class=" justify-content-center my-2 mr-3 me-3 text-dark">
        ...
        <svg width="205" height="45" viewBox="0 0 305 45" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="swiper-container mySwiper p-4 mb-3">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="#"><img
                                src="{{ url('') }}/public/concept/assets/images/Logplace__11.png" class="d-block w-100"
                                alt="..."></a></div>
                    <div class="swiper-slide"><a href=" https://t.me/logmkp"><img
                                src="{{ url('') }}/public/concept/assets/images/Logplace__2.png" class="d-block w-100"
                                alt="..."></a></div>
                    <div class="swiper-slide"><a href="https://tinyurl.com/logsgroup2"><img
                                src="{{ url('') }}/public/concept/assets/images/Logplace__5.png" class="d-block w-100"
                                alt="..."></a></div>
                    ...
                    <div class="swiper-slide"><a href="https://t.me/logmarketplacee"><img
                                src="{{ url('') }}/public/concept/assets/images/Logplace__4.png" class="d-block w-100"
                                alt="..."></a></div>
                                                ...
                                                50, '...Show more')}}</a>
                                                        ...
                                                        <form action="/allcatproduct" method="GET">
                                                            ...
                                                            <button type="submit" data-cat="48"
                                                                    data-collapse="#subcat_48" data-name="Hide accounts"
                                                                    class="btn   btn-warning my-3 btn-sm btn-block text-white"
                                                                    style="border-radius: 10px; background: linear-gradient(279deg, #FF0B9E -6.58%, #FF6501 121.69%);">
                                                                View
                                                                all
                                                                ...
                                                                {{--RESELLER Deal--}}
                                                                    ...
                                                                    <div class="container">
                                                                        ...
                                                                        <div class="card p-3">
                                                                            ...
                                                                            <p class="small">A good social media account
                                                                                has an active and responsive community
                                                                                fired up by the
                                                                                topic or niche that brought them
                                                                                together.</p>
                                                                            <p class="small">Sometimes it makes sense to
                                                                                buy or sell a social media account
                                                                                depending on where
                                                                                you are with your business and how goals
                                                                                have changed and evolved.</p>
                                                                            <p class="small">There is a thriving market
