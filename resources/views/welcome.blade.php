                        ...
                        <div class="card-body border-0">
                            ...
                            <p class="text-center"> Customer Care:<a href="https://t.me/logmarketplacee">Chat Customer
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <table class="">
                                        <tr class="mr-2">
                                            <td class="ml-2"><a href="https://t.me/logsmarkeplace"><i class="fa fa-telegram" style="font-size:40px"></i></a></td>
                                            <td><a href="https://chat.whatsapp.com/I1DAA6YDWC8GjuQMU4Tn8I"><i class="fa fa-whatsapp fa-3x" aria-hidden="true"></i></a></td>
                                        </tr>
                                    </table>
        ...
        <div class="flex">
            ...
            <div class="swiper-container mySwiper p-4 mb-3">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="#"><img src="{{ url('') }}/public/concept/assets/images/Logplace__11.png" class="d-block w-100" alt="..."></a> </div>
                    <div class="swiper-slide"><a href=" https://t.me/logmkp"><img src="{{ url('') }}/public/concept/assets/images/Logplace__2.png" class="d-block w-100" alt="..."></a></div>
                ...
                <div class="col-5">
                    ...
                    <div class="category-nav my-3">
                        <button class="category-nav__button" style="background: #10113D;">
                            <span class="icon me-1"><img src="{{ url('')}}/public/img/grid.png" alt="@lang('image')"></span><span class="search-text text-white">@lang('
                                Category')</span>
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <td class="">
                                <a href="#" data-help="Click to read detailed description">
                                    <img src="{{ url('') }}/public/storage/content/images/{{ $data->icon }}" height="20" width="20" loading="lazy">
                                </a>
                            </td>
                    ...
                    <form action="/allcatproduct" method="GET">
                        ...
                        <button type="submit" data-cat="48" data-collapse="#subcat_48" data-name="Hide accounts" class="btn   btn-warning my-3 btn-sm btn-block text-white" style="border-radius: 10px; background: linear-gradient(279deg, #FF0B9E -6.58%, #FF6501 121.69%);">View
